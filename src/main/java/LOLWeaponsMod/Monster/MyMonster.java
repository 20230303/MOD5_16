...
public class MyMonster extends CustomMonster {
    ...
    private static final String ID = LOLWeaponsMod.helpers.ModHelper.makePath("MyMonster");
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);
    public static final String NAME = monsterStrings.NAME;
    // 怪物的图片，请自行添加
    public static final String IMG = "PEACH_LOLWeaponsModResources/img/monster/Kakaa.png";
