...
public class ShuoJiZhiMao extends CustomRelic {
    public static final String ID = ModHelper.makePath("ShuoJiZhiMao");
    public static final String IMG_PATH = "PEACH_LOLWeaponsModResources/img/relics/ShuoJiZhiMao.png";
    public static final String OUTLINE_PATH = "PEACH_LOLWeaponsModResources/img/relics/ShuoJiZhiMao.png";
